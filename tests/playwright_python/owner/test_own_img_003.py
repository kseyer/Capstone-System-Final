"""
OWN-IMG-003: Set primary service image
Test Scenario: Verify owner can set primary service image
"""
import pytest
...
def test_own_img_003_set_primary_service_image(page: Page):
    """OWN-IMG-003: Set primary service image"""
    ...
    if primary_button.is_visible(timeout=2000):
        ...
        page.goto(f"{BASE_URL}/owner/set-primary-service-image/5/")
        page.wait_for_load_state("networkidle")
    ...
    # Screenshot after
    take_screenshot(page, "owner/OWN-IMG-003-after.png")
